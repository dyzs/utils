...
import com.dyzs.zxing.decoding.CaptureActivityHandler;
import com.dyzs.zxing.decoding.InactivityTimer;
import com.dyzs.zxing.view.ViewfinderView;
...
public class CaptureFragment extends Fragment implements SurfaceHolder.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (view == null) {
            view = inflater.inflate(R.layout.frag_capture, container);
        }
    ...
    private void playBeepSoundAndVibrate() {
        ...
        if (vibrate) {
            Vibrator vibrator = (Vibrator) getActivity().getSystemService(FragmentActivity.VIBRATOR_SERVICE);
     ...
     * @param layoutId
     */
    public void setFragmentArgs( int layoutId) {
        if (layoutId == -1) {
            return;
        }
