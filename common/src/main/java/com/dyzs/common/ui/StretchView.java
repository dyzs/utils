...
public class StretchView extends ViewGroup {
    ...
    private View mViewBody, mViewDragger, mViewSlider;
    ...
    protected void onFinishInflate() {
        ...
        mViewToolbar = findViewWithTag("TAG_TOOLBAR");
        mViewBody = getChildAt(0);
        mViewDragger = findViewWithTag("TAG_DRAGGER");
        mViewSlider = findViewWithTag("TAG_SLIDER");
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mViewBody.measure(widthMeasureSpec, heightMeasureSpec);

        // measure view dragger
        int draggerHeight = MeasureSpec.makeMeasureSpec(mViewDragger.getLayoutParams().height, MeasureSpec.EXACTLY);
        mViewDragger.measure(widthMeasureSpec, draggerHeight);

        //
        int displayHeight = getResources().getDisplayMetrics().heightPixels;
        int sliderHeight = displayHeight - mViewToolbar.getMeasuredHeight();
        mViewSlider.measure(widthMeasureSpec, sliderHeight);
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        mViewBody.layout(0, 0, mViewBody.getMeasuredWidth(), mViewBody.getMeasuredHeight());
        mViewDragger.layout(0, 0, mViewDragger.getMeasuredWidth(), mViewDragger.getMeasuredHeight());

        int displayHeight = getResources().getDisplayMetrics().heightPixels;
        mViewSlider.layout(0, mViewToolbar.getMeasuredHeight(), mViewSlider.getMeasuredWidth(), displayHeight);
    }
    ...
    class StretchDragHelper extends  ViewDragHelper.Callback {
        ...
        public void onViewPositionChanged(View changedView, int left, int top, int dx, int dy) {
            ...
            // ViewCompat.offsetTopAndBottom(, dy);
        ...
        public void onViewReleased(View releasedChild, float xVel, float yVel) {
            ...
            int releasePartTop = mViewDragger.getTop();
        ...
        private void openStretchView() {
            viewDragHelper.smoothSlideViewTo(mViewDragger,0, mUpPartHeight);
            isFullStretch = true;
        }
        ...
        private void closeStretchView() {
            viewDragHelper.smoothSlideViewTo(mViewDragger,0,0);
            isFullStretch = false;
        }
